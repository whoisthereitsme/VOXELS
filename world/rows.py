...
class ROWS:
    ...
    def __init__(self) -> None:
        ...
        self.p0 = (ROW.XMIN, ROW.YMIN, ROW.ZMIN)    # these are constant throughout
        self.p1 = (ROW.XMAX, ROW.YMAX, ROW.ZMAX)    # these are constant throughout
